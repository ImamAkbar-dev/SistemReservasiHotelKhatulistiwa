...
// Query reservasi yang sudah Lunas dan masih ada kamar Terisi
...
<head>
    ...
    <style>
        /* style sama seperti sebelumnya, tambahkan .search-form */
        ...
        /* sisanya copy dari style sebelumnya */
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .btn-checkout { background: #10B981; color: white; padding: 6px 12px; border-radius: 20px; text-decoration: none; }
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="../../process/Resepsionis/proses_checkout.php?id=<?= $row['id_Reservasi'] ?>" class="btn-checkout" onclick="return confirm('Check-out?')">✅ Check-Out</a></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
